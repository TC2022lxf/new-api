# Focus API Electron Desktop App

This directory contains the Electron wrapper for Focus API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Focus API/data/`
  - Windows: `%APPDATA%/Focus API/data/`
  - Linux: `~/.config/Focus API/data/`
