...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.FocusAPIError {
	...
	key, index, FocusAPIError := channel.GetNextEnabledKey()
