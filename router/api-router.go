...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/stats/summary", controller.GetStatsSummary)
		...
		// Public alias for the perf summary — no auth required; used by model marketplace
		apiRouter.GET("/perf/summary", controller.GetPerfMetricsSummary)
