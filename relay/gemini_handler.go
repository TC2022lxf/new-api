...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (FocusAPIError *types.FocusAPIError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (FocusAPIError *types.FocusAPIError) {
	info.InitChannelMeta(c)
